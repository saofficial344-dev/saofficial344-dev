...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        Business dashboards with analytics cards, CRUD systems,
        role-based access, tables, filters, and professional layouts.
      </p>
    </td>
    <td width="50%" valign="top">
...
<table>
  <tr>
    ...
    <td width="25%" align="center">
      <h3>Database</h3>
      <img src="https://skillicons.dev/icons?i=mongodb,postgresql,mysql&perline=3" alt="Database Skills" />
    </td>
    <td width="25%" align="center">
      <h3>Tools</h3>
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><strong>Stack:</strong> MERN Stack</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
